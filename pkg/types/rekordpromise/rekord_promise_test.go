...
func TestRekordPromiseType(t *testing.T) {
	// empty to start
	...
	// version requested fails to match implementation in map
	u.RekordPromise.APIVersion = swag.String("not_a_version")
	if _, err := brt.UnmarshalEntry(&u.RekordPromise); err == nil {
